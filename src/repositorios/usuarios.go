...
// Buscar traz todos os usuários que atendam um filtro de nome ou nick
...
// BuscarUsuarioPorID traz um usuário do banco de dados
...
// Atualizar altera as informações de unm usuário no banco de dados
